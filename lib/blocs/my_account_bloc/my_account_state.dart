...
class GetMyAccountDetailsCompletedState extends MyAccountState {
  final Seller seller;
  GetMyAccountDetailsCompletedState(this.seller);
...
class ChangePasswordInProgressState extends MyAccountState {}

class ChangePasswordFailedState extends MyAccountState {}

class ChangePasswordCompletedState extends MyAccountState {
  final String res;

  ChangePasswordCompletedState(this.res);
}
