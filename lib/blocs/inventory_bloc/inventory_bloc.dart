...
class InventoryBloc extends Bloc<InventoryEvent, InventoryState> {
  ...
  Stream<InventoryState> mapGetInventoryAnalyticsEventToState() async* {
    ...
    try {
      inventoryAnalyticsSubscription?.cancel();
      inventoryAnalyticsSubscription = userDataRepository
          .getInventoryAnalytics()
          .listen((inventoryAnalytics) {
  ...
  Stream<InventoryState> mapUpdateOrderAnalyticsEventToState(
      InventoryAnalytics inventoryAnalytics) async* {
    yield GetInventoryAnalyticsCompletedState(
