...
import 'package:multivendor_seller/widgets/dialogs/assign_delivery_guy_dialog.dart';
import 'package:multivendor_seller/widgets/dialogs/delete_confirm_dialog.dart';
import 'package:multivendor_seller/widgets/dialogs/proceed_order_dialog.dart';
...
import 'package:multivendor_seller/widgets/order_product_item.dart';
                    ...
                    children: <Widget>[
                      ...
                      widget.order.orderStatus == 'Cancelled'
                          ? Column(
                              children: <Widget>[
                                ...
                                widget.order.paymentDetails.paymentMethod ==
                                            'STRIPE' ||
                                            ...
                                            children: <Widget>[
                                              ...
                                              Expanded(
                                                child: Text(
                                                  widget.order.refundStatus ==
                                                          'Processed'
                                                      ? '${widget.order.paymentDetails.refundTransactionId}'
                                                      : 'NA',
                                                  style: GoogleFonts.poppins(
                                                    color: Colors.black
                                                        .withOpacity(0.8),
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          ...
                          Expanded(
                            child: Text(
                              widget.order.paymentDetails.paymentMethod == 'COD'
                                  ? 'Cash on delivery'
                                  : 'Credit/Debit card',
                              style: GoogleFonts.poppins(
                                color: Colors.black.withOpacity(0.8),
                      ...
                      widget.order.paymentDetails.paymentMethod == 'RAZORPAY' ||
                              widget.order.paymentDetails.paymentMethod ==
                                  'STRIPE'
                          ? Column(
                              children: <Widget>[
                          ...
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (context) => AddressMapScreen(
                                address: Address(
                                  fullAddress: widget.order.custDetails
                                      .locationDetails.address,
                                  location: GeoPoint(
                                    widget.order.custDetails.locationDetails
                                        .location.latitude,
                                    widget.order.custDetails.locationDetails
                                        .location.longitude,
                                  ),
                                  placeId: widget.order.custDetails
                                      .locationDetails.placeId,
                                  tag: '',
                                  postalCode: widget.order.custDetails
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      widget.order.charges.walletAmt != null
                          ? Column(
                              children: [
                                SizedBox(
                                  height: 8.0,
                                ...
                                Row(
                                  ...
                                  children: <Widget>[
                                    ...
                                    Text(
                                      '- ${Config().currency}${widget.order.charges.walletAmt}',
                                      style: GoogleFonts.poppins(
                                        color: Colors.black.withOpacity(0.8),
                                        fontSize: 13.5,
                                        fontWeight: FontWeight.w500,
                          ...
                          : SizedBox(),
                      widget.order.charges.appliedCoupon
                          ? Column(
                              children: [
                                SizedBox(
                                  height: 8.0,
                                ...
                                Row(
                                  ...
                                  children: <Widget>[
                                    Expanded(
                                      child: Text(
                                        'Coupon (${widget.order.charges.couponCode}):',
                                        style: GoogleFonts.poppins(
                                          color: Colors.black.withOpacity(0.65),
                                          fontSize: 13.5,
                                          fontWeight: FontWeight.w500,
                                    ...
                                    Text(
                                      '-${Config().currency}${widget.order.charges.couponDiscountAmt}',
                                      style: GoogleFonts.poppins(
                                        color: Colors.black.withOpacity(0.8),
                                        fontSize: 13.5,
                                        fontWeight: FontWeight.w500,
