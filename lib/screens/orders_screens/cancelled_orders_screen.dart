...
class _CancelledOrdersScreenState extends State<CancelledOrdersScreen>
  ...
  void initState() {
    ...
    cancelledOrdersBloc.add(GetCancelledOrdersEvent());
  }
    ...
    return Scaffold(
      body: Column(
        children: <Widget>[
          ...
          Expanded(
            child: BlocBuilder(
              bloc: cancelledOrdersBloc,
              buildWhen: (previous, current) {
                if (current is GetCancelledOrdersCompletedState ||
                    current is GetCancelledOrdersInProgressState ||
                    current is GetCancelledOrdersFailedState) {
                  return true;
                }
                return false;
              },
              builder: (context, state) {
                if (state is GetCancelledOrdersInProgressState) {
                ...
                if (state is GetCancelledOrdersFailedState) {
                  return Center(
                    child: Text(
