...
class ActivatedDeliveryUsersScreen extends StatefulWidget {
  @override
  _ActivatedDeliveryUsersScreenState createState() =>
      _ActivatedDeliveryUsersScreenState();
}

class _ActivatedDeliveryUsersScreenState
    extends State<ActivatedDeliveryUsersScreen>
    with SingleTickerProviderStateMixin {
  List<DeliveryUser> deliveryUsers;
  ActivatedDeliveryUsersBloc activatedDeliveryUsersBloc;
  ...
  void initState() {
    ...
    activatedDeliveryUsersBloc =
        BlocProvider.of<ActivatedDeliveryUsersBloc>(context);
    deactivateDeliveryUserBloc =
        BlocProvider.of<DeactivateDeliveryUserBloc>(context);
    deliveryUsers = List();

    activatedDeliveryUsersBloc.add(GetActivatedDeliveryUsersEvent());
    ...
    return Scaffold(
      body: Column(
        children: <Widget>[
          ...
          Expanded(
            child: BlocBuilder(
              bloc: activatedDeliveryUsersBloc,
              buildWhen: (previous, current) {
                if (current is GetActivatedDeliveryUsersCompletedState ||
                    current is GetActivatedDeliveryUsersInProgressState ||
                    current is GetActivatedDeliveryUsersFailedState) {
                  return true;
                }
                return false;
              },
              builder: (context, state) {
                if (state is GetActivatedDeliveryUsersInProgressState) {
                  return Center(
                ...
                if (state is GetActivatedDeliveryUsersFailedState) {
                  return Center(
                    child: Text(
                ...
                if (state is GetActivatedDeliveryUsersCompletedState) {
