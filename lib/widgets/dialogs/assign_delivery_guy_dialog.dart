...
class AssignDeliveryGuyDialog extends StatefulWidget {
  final List<DeliveryUser> deliveryUsers;
  final ProceedOrderBloc proceedOrderBloc;
  final Order order;

  const AssignDeliveryGuyDialog({
    this.deliveryUsers,
  ...
  @override
  _AssignDeliveryGuyDialogState createState() =>
      _AssignDeliveryGuyDialogState();
}

class _AssignDeliveryGuyDialogState extends State<AssignDeliveryGuyDialog> {
                ...
                child: DropdownButton<String>(
                    ...
                    onChanged: (String uid) {
                      setState(() {
                        ...
                        for (var i = 0; i < widget.deliveryUsers.length; i++) {
